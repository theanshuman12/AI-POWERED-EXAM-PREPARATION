...
export const UPPET_PAPER_MOCK_TOPICS: Topic[] = [
  ...
  { id: 'top-uppet-paper-mock-ancient-india', subjectId: 'subj-uppet-paper-mock', name: 'Ancient India', description: 'Harappan civilization, Vedic culture, Buddhism, Jainism, Mauryan and Gupta history.' },
  { id: 'top-uppet-paper-mock-vedic-age', subjectId: 'subj-uppet-paper-mock', name: 'Vedic Age', description: 'The Vedas and major features of Vedic society and culture.' },
  { id: 'top-uppet-paper-mock-buddhism', subjectId: 'subj-uppet-paper-mock', name: 'Buddhism', description: 'The life, teachings, places and spread of Buddhism.' },
  { id: 'top-uppet-paper-mock-jainism', subjectId: 'subj-uppet-paper-mock', name: 'Jainism', description: 'Mahavira, Tirthankaras and the core principles of Jainism.' },
  { id: 'top-uppet-paper-mock-mauryan', subjectId: 'subj-uppet-paper-mock', name: 'Mauryan Empire', description: 'Chandragupta Maurya, Ashoka and the Mauryan administration.' },
  { id: 'top-uppet-paper-mock-gupta', subjectId: 'subj-uppet-paper-mock', name: 'Gupta Empire', description: 'Gupta rulers, achievements and the classical age of India.' },
  { id: 'top-uppet-paper-mock-medieval-india', subjectId: 'subj-uppet-paper-mock', name: 'Medieval India', description: 'Mughal history, major rulers, battles and monuments.' },
  { id: 'top-uppet-paper-mock-british-rule', subjectId: 'subj-uppet-paper-mock', name: 'British Rule', description: 'Colonial administration, policies and important British-era events.' },
  { id: 'top-uppet-paper-mock-early-nationalism', subjectId: 'subj-uppet-paper-mock', name: 'Early Nationalism', description: 'The formation of the Indian National Congress and early national leaders.' },
  { id: 'top-uppet-paper-mock-swadeshi', subjectId: 'subj-uppet-paper-mock', name: 'Swadeshi Movement', description: 'The partition of Bengal and the Swadeshi movement.' },
  { id: 'top-uppet-paper-mock-gandhian-era', subjectId: 'subj-uppet-paper-mock', name: 'Gandhian Era', description: 'Major Gandhian movements including Champaran and Dandi.' },
  { id: 'top-uppet-paper-mock-quit-india', subjectId: 'subj-uppet-paper-mock', name: 'Quit India Movement', description: 'The 1942 movement and the call for an end to British rule.' },
  { id: 'top-uppet-paper-mock-revolutionary', subjectId: 'subj-uppet-paper-mock', name: 'Revolutionary Movement', description: 'Revolutionary organizations and events such as Kakori.' },
  { id: 'top-uppet-paper-mock-ina', subjectId: 'subj-uppet-paper-mock', name: 'INA', description: 'The Indian National Army and Subhas Chandra Bose.' },
  { id: 'top-uppet-paper-mock-independence', subjectId: 'subj-uppet-paper-mock', name: 'Independence', description: 'Events surrounding the transfer of power and Indian independence.' },
  { id: 'top-uppet-paper-mock-physical-geography', subjectId: 'subj-uppet-paper-mock', name: 'Physical Geography', description: 'Landforms, latitude and major physical features of India.' },
  { id: 'top-uppet-paper-mock-rivers', subjectId: 'subj-uppet-paper-mock', name: 'Rivers', description: 'Indian rivers, drainage and important river facts.' },
  { id: 'top-uppet-paper-mock-soils', subjectId: 'subj-uppet-paper-mock', name: 'Soils', description: 'Types, properties and agricultural uses of Indian soils.' },
  { id: 'top-uppet-paper-mock-agriculture', subjectId: 'subj-uppet-paper-mock', name: 'Agriculture', description: 'Kharif crops and key patterns of Indian agriculture.' },
  { id: 'top-uppet-paper-mock-water', subjectId: 'subj-uppet-paper-mock', name: 'Water Resources', description: 'Groundwater, aquifers and water resource concepts.' },
  { id: 'top-uppet-paper-mock-climate', subjectId: 'subj-uppet-paper-mock', name: 'Climate', description: 'Indian monsoon and climate patterns.' },
  { id: 'top-uppet-paper-mock-atmosphere', subjectId: 'subj-uppet-paper-mock', name: 'Atmosphere', description: 'Atmospheric layers, weather and the ozone layer.' },
  { id: 'top-uppet-paper-mock-coasts', subjectId: 'subj-uppet-paper-mock', name: 'Coasts', description: 'Indian coasts, lagoons and coastal geography.' },
  { id: 'top-uppet-paper-mock-banking', subjectId: 'subj-uppet-paper-mock', name: 'Banking', description: 'RBI and basic banking concepts.' },
  { id: 'top-uppet-paper-mock-inflation', subjectId: 'subj-uppet-paper-mock', name: 'Inflation', description: 'Inflation and changes in the general price level.' },
  { id: 'top-uppet-paper-mock-monetary-policy', subjectId: 'subj-uppet-paper-mock', name: 'Monetary Policy', description: 'Repo rate and monetary policy instruments.' },
  { id: 'top-uppet-paper-mock-economic-reforms', subjectId: 'subj-uppet-paper-mock', name: 'Economic Reforms', description: 'Liberalization and India\'s economic reforms.' },
  { id: 'top-uppet-paper-mock-taxation', subjectId: 'subj-uppet-paper-mock', name: 'Taxation', description: 'GST and fundamental taxation concepts.' },
  { id: 'top-uppet-paper-mock-external-trade', subjectId: 'subj-uppet-paper-mock', name: 'External Trade', description: 'GATT, WTO and international trade basics.' },
  { id: 'top-uppet-paper-mock-financial-markets', subjectId: 'subj-uppet-paper-mock', name: 'Financial Markets', description: 'SEBI and the securities market.' },
  { id: 'top-uppet-paper-mock-planning', subjectId: 'subj-uppet-paper-mock', name: 'Planning', description: 'Five-Year Plans and national economic planning.' },
  { id: 'top-uppet-paper-mock-rural-development', subjectId: 'subj-uppet-paper-mock', name: 'Rural Development', description: 'NABARD, agriculture finance and rural development.' },
  { id: 'top-uppet-paper-mock-constitution', subjectId: 'subj-uppet-paper-mock', name: 'Constitution', description: 'Constitutional history and important provisions.' },
  { id: 'top-uppet-paper-mock-fundamental-rights', subjectId: 'subj-uppet-paper-mock', name: 'Fundamental Rights', description: 'Fundamental rights and important constitutional articles.' },
  { id: 'top-uppet-paper-mock-directive-principles', subjectId: 'subj-uppet-paper-mock', name: 'Directive Principles', description: 'Directive Principles of State Policy.' },
  { id: 'top-uppet-paper-mock-parliament', subjectId: 'subj-uppet-paper-mock', name: 'Parliament', description: 'Parliament, Money Bills and legislative procedure.' },
  { id: 'top-uppet-paper-mock-president', subjectId: 'subj-uppet-paper-mock', name: 'President', description: 'The President and the Union executive.' },
  { id: 'top-uppet-paper-mock-judiciary', subjectId: 'subj-uppet-paper-mock', name: 'Judiciary', description: 'The Supreme Court and Indian judicial system.' },
  { id: 'top-uppet-paper-mock-election-commission', subjectId: 'subj-uppet-paper-mock', name: 'Election Commission', description: 'Election Commission and electoral administration.' },
  { id: 'top-uppet-paper-mock-panchayati-raj', subjectId: 'subj-uppet-paper-mock', name: 'Panchayati Raj', description: 'The 73rd Amendment and rural local government.' },
  { id: 'top-uppet-paper-mock-municipalities', subjectId: 'subj-uppet-paper-mock', name: 'Municipalities', description: 'The 74th Amendment and urban local government.' },
  { id: 'top-uppet-paper-mock-physics', subjectId: 'subj-uppet-paper-mock', name: 'Physics', description: 'Force, power, lenses and basic physics.' },
  { id: 'top-uppet-paper-mock-chemistry', subjectId: 'subj-uppet-paper-mock', name: 'Chemistry', description: 'Formulas, reactions, acids, bases and pH.' },
  { id: 'top-uppet-paper-mock-biology', subjectId: 'subj-uppet-paper-mock', name: 'Biology', description: 'Cells, human body, plants, vitamins and hormones.' },
  { id: 'top-uppet-paper-mock-environment', subjectId: 'subj-uppet-paper-mock', name: 'Environment', description: 'Ozone, greenhouse gases and environmental awareness.' },
  { id: 'top-uppet-paper-mock-general-hindi-synonyms', subjectId: 'subj-uppet-paper-mock', name: 'पर्यायवाची', description: 'Hindi synonyms.' },
  { id: 'top-uppet-paper-mock-general-hindi-antonyms', subjectId: 'subj-uppet-paper-mock', name: 'विलोम शब्द', description: 'Hindi antonyms.' },
  { id: 'top-uppet-paper-mock-general-hindi-one-word', subjectId: 'subj-uppet-paper-mock', name: 'एक शब्द', description: 'Hindi one-word substitutions.' },
  { id: 'top-uppet-paper-mock-general-hindi-idioms', subjectId: 'subj-uppet-paper-mock', name: 'मुहावरे', description: 'Hindi idioms and meanings.' },
  { id: 'top-uppet-paper-mock-general-hindi-literature', subjectId: 'subj-uppet-paper-mock', name: 'लेखक-रचना', description: 'Hindi authors and literary works.' },
  { id: 'top-uppet-paper-mock-english-grammar', subjectId: 'subj-uppet-paper-mock', name: 'Grammar', description: 'English grammar and usage.' },
  { id: 'top-uppet-paper-mock-english-vocabulary', subjectId: 'subj-uppet-paper-mock', name: 'Vocabulary', description: 'English synonyms and antonyms.' },
  { id: 'top-uppet-paper-mock-number-series', subjectId: 'subj-uppet-paper-mock', name: 'Number Series', description: 'Number patterns and sequences.' },
  { id: 'top-uppet-paper-mock-alphabet-series', subjectId: 'subj-uppet-paper-mock', name: 'Alphabet Series', description: 'Alphabet patterns and sequences.' },
  { id: 'top-uppet-paper-mock-analogy', subjectId: 'subj-uppet-paper-mock', name: 'Analogy', description: 'Word and relationship analogies.' },
  { id: 'top-uppet-paper-mock-odd-one-out', subjectId: 'subj-uppet-paper-mock', name: 'Odd One Out', description: 'Classification and odd-one-out reasoning.' },
  { id: 'top-uppet-paper-mock-coding-decoding', subjectId: 'subj-uppet-paper-mock', name: 'Coding-Decoding', description: 'Letter and word coding patterns.' },
  { id: 'top-uppet-paper-mock-blood-relation', subjectId: 'subj-uppet-paper-mock', name: 'Blood Relation', description: 'Family and relationship reasoning.' },
  { id: 'top-uppet-paper-mock-direction', subjectId: 'subj-uppet-paper-mock', name: 'Direction', description: 'Direction and distance reasoning.' },
  { id: 'top-uppet-paper-mock-ranking', subjectId: 'subj-uppet-paper-mock', name: 'Ranking', description: 'Ranking and ordering problems.' },
  { id: 'top-uppet-paper-mock-clock', subjectId: 'subj-uppet-paper-mock', name: 'Clock', description: 'Clock and angle reasoning.' },
  { id: 'top-uppet-paper-mock-statement-conclusion', subjectId: 'subj-uppet-paper-mock', name: 'Statement Conclusion', description: 'Statement and conclusion reasoning.' },
  { id: 'top-uppet-paper-mock-international-affairs', subjectId: 'subj-uppet-paper-mock', name: 'International Affairs', description: 'International organizations and current affairs.' },
  { id: 'top-uppet-paper-mock-important-days', subjectId: 'subj-uppet-paper-mock', name: 'Important Days', description: 'Important national and international days.' },
  { id: 'top-uppet-paper-mock-brics', subjectId: 'subj-uppet-paper-mock', name: 'BRICS', description: 'BRICS and related current affairs.' },
  { id: 'top-uppet-paper-mock-sports', subjectId: 'subj-uppet-paper-mock', name: 'Sports', description: 'Sports events and achievements.' },
  { id: 'top-uppet-paper-mock-national-symbols', subjectId: 'subj-uppet-paper-mock', name: 'National Symbols', description: 'National symbols and related awareness.' },
  { id: 'top-uppet-paper-mock-national-affairs', subjectId: 'subj-uppet-paper-mock', name: 'National Affairs', description: 'Important national events and awareness.' },
  { id: 'top-uppet-paper-mock-uttar-pradesh-gk', subjectId: 'subj-uppet-paper-mock', name: 'Uttar Pradesh GK', description: 'Important places and facts about Uttar Pradesh.' }
];
...
export const UPPET_PAPER_MOCK_TESTS: Test[] = Array.from({ length: 10 }, (_, index) => ({
  ...
  title: index < 7 ? `UPPET Paper Mock ${index + 1}` : `Additional Mock ${index - 6}`,
  subjectId: 'subj-uppet-paper-mock',
